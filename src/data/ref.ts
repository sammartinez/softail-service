...
export const DTC_HOWTO: DtcHowto = {
  carb: [
...
/* ---------- Parts ---------- */
export const STORES: readonly string[] = ["All", "AutoZone", "O'Reilly", "NAPA", "Dealer", "Online"];
export const LOCAL: readonly StoreName[] = ["AutoZone", "O'Reilly", "NAPA"];
...
export const LINKS: Record<PartId, PartId[]> = { mobil: ["t-mobil", "p-mobil"] };
export const MERGE: Record<PartId, PartId> = { "t-mobil": "mobil", "p-mobil": "mobil", "p-castrol": "castrol" };
export const QTY: Record<PartCat, Qty> = { "Oil filter": [1, "", "each"], "Engine oil (4 qt)": [4, "qt", "per qt"], "Transmission (1 qt)": [1, "qt", "per qt"], "Primary chaincase (1 qt)": [1, "qt", "per qt"] };
export const ITEMQTY: Record<PartId, Qty> = { oring: [2, "", "each"], quad: [1, "", "each"], plugs6r12: [2, "", "each"] };
export const HINTS: Record<PartId, string> = { kn171c: "AutoZone listed it at $19.99." };
